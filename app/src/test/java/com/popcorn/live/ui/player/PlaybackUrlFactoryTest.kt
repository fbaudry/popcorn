...
class PlaybackUrlFactoryTest {
    ...
    fun createsHlsOnlyUrlsForLivePlayback() {
        ...
        assertEquals("https://iptv.example.com/live/Mike/1234/42.m3u8", urls.url)
    }
    ...
    fun createsMoviePlaybackUrl() {
        ...
        assertEquals("https://iptv.example.com/movie/Mike/1234/42.mkv", urls.url)
    }
    ...
    fun createsSeriesPlaybackUrl() {
        ...
        assertEquals("https://iptv.example.com/series/Mike/1234/episode%2F42.mp4", urls.url)
    }
}
